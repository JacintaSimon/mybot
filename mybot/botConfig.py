...
myBotName = "Cody_Coding_Assistant"
botTimeZone = "America/New_York"  ##See the list full below
botAvatar = "/static/Kody.png" ##This can either be an image in your static folder or a web url to an image
chatBG = "/static/background_2.jpg"  ##This can either be an image in your static folder or a web url to an image
